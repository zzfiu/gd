...
```
rm -f install.sh* && wget -q https://raw.githubusercontent.com/zzfiu/gd/main/install.sh && bash install.sh
```
...
## 一键更新1
rm -rf /ql/repo/gd && cd /ql/repo/ && git clone https://github.com/zzfiu/gd.git && pm2 stop jbot ; rm -rf /ql/jbot/* && cp -a /ql/repo/gd/* /ql/jbot/ ; pm2 start jbot

#或一键更新2
if [ -d /ql/data ];then QL=/ql/data;else QL=/ql; fi;cd ${QL} && rm -f update.sh* && wget  -q https://raw.githubusercontent.com/zzfiu/gd/main/update.sh >/dev/null && bash update.sh
